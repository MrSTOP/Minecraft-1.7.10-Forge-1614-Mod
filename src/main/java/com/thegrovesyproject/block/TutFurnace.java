...
public class TutFurnace extends BlockContainer {
	...
	protected TutFurnace(boolean isActive) {
		super(Material.rock);
		isBurning2 = isActive;
	}
	...
	private void direction(World world, int x, int y, int z) {
		if (!world.isRemote) {
			...
			if (direction.isFullBlock() && direction.isFullBlock()) {
				byte0 = 3;
			}

			if (direction1.isFullBlock() && direction1.isFullBlock()) {
				byte0 = 2;
			}

			if (direction2.isFullBlock() && direction2.isFullBlock()) {
				byte0 = 5;
			}

			if (direction3.isFullBlock() && direction3.isFullBlock()) {
				byte0 = 4;
			}
	...
	public static void updateBlockState(boolean burning, World world, int x, int y, int z) {
		...
		if (burning) {
			world.setBlock(x, y, z, TMBlock.tutFurnaceActive);
		} else {
			world.setBlock(x, y, z, TMBlock.tutFurnace);
		}
