...
public class TutChest extends BlockChest {
    ...
    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        ...
        if (tileentitychest != null)
        {
            for (int i1 = 0; i1 < tileentitychest.getSizeInventory(); ++i1)
            {
                ...
                if (itemstack != null)
                {
                    ...
                    for (float f2 = this.field_149955_b.nextFloat() * 0.8F + 0.1F; itemstack.stackSize > 0; p_149749_1_.spawnEntityInWorld(entityitem))
                    {
                        ...
                        entityitem = new EntityItem(p_149749_1_, (double)((float)p_149749_2_ + f), (double)((float)p_149749_3_ + f1), (double)((float)p_149749_4_ + f2), new ItemStack(itemstack.getItem(), j1, itemstack.getMetadata()));
                        float f3 = 0.05F;
            ...
            p_149749_1_.updateNeighborsAboutBlockChange(p_149749_2_, p_149749_3_, p_149749_4_, p_149749_5_);
        }
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(Strings.MODID + ":TutChest");
    }
