package com.thegrovesyproject.gui;
...
public class GuiTutFurnace extends GuiContainer{
	...
	private TileEntityTutFurnace tileFurnace;

	public GuiTutFurnace(InventoryPlayer invPlayer, TileEntityTutFurnace tile) {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2){
		String string = this.tileFurnace.isCustomInventoryName() ? this.tileFurnace.getInventoryName() : I18n.format(this.tileFurnace.getInventoryName(), new Object[0]);
