package com.thegrovesyproject.render.tile_entity;
...
import com.thegrovesyproject.block.TutChest;
...
public class TutChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation field_147505_d = new ResourceLocation(Strings.MODID + ":textures/blocks/LargeTutChest.png");
    private static final ResourceLocation field_147504_g = new ResourceLocation(Strings.MODID + ":textures/blocks/TutChest.png");
    private ModelChest field_147510_h = new ModelChest();
    private ModelChest field_147511_i = new ModelLargeChest();
    private boolean field_147509_j;
    private static final String __OBFID = "CL_00000965";

    public TutChestRenderer()
    {
    ...
    public void renderTileEntityAt(TileEntityTutChest p_147502_1_, double p_147502_2_, double p_147502_4_, double p_147502_6_, float p_147502_8_)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof TutChest && i == 0)
            {
                try
                {
                ((TutChest)block).initMetadata(p_147502_1_.getWorld(), p_147502_1_.xCoord, p_147502_1_.yCoord, p_147502_1_.zCoord);
                }
    ...
    {
        this.renderTileEntityAt((TileEntityTutChest)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}